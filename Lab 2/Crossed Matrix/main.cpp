...
public:
    ...
    float cross_a_col(int the_col) // sum of vertical lines
    {
    ...
    float cross_a_row(int the_row) // sum of horizontal lines
    {
...
public:
    ...
    int gen_rdm_info(const char* file_path)
    {
        ...
        float unit_price[] = {1.25 , 5.00 , 8.50 , 14.00};
        //float LO = 1, HI = 50; // uncomment for random values
        float rtd;
        ...
        /* uncomment this as well if you want to use random values for unit_price
...
int main()
{
    const char* file_path = "/home/thomas/Desktop/data.txt"; // please edit this
    int n_products = 4;
    int n_salesperson = 5;
    ...
    cout << endl << "CROSSED MATRIX" << endl << endl;
